...
public final class TestHelper {
  ...
  static {
    ...
    MOVIES_URL  = "http://localhost:60316/emdb/api/movies";
    PEOPLE_URL  = "http://localhost:60316/emdb/api/people";
    SERIES_URL  = "http://localhost:60316/emdb/api/series";
    GRAPHQL_URL = "http://localhost:60316/emdb/api/graphql";
  }  
