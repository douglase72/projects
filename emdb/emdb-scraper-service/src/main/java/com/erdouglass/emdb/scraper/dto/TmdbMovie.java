...
public record TmdbMovie(@NotNull @Positive Integer id,
    ...
    @PositiveOrZero Float vote_average, @NotNull @Size(max = ShowConstants.STATUS_MAX_LENGTH) ShowStatus status,
  ...
  public record CastCredit (
      ...
      @Size(min = PersonConstants.PROFILE_MIN_LENGTH, max = PersonConstants.PROFILE_MAX_LENGTH) String 
      profile_path,
