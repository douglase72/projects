...
/// Full detail projection of a person, returned by single-entity lookups
/// and write operations.
///
/// Includes all person fields. Associated data such as credits may be
/// appended via the `append` query parameter on the gateway endpoint.
