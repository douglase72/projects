...
public enum Gender {
  /// Gender is not specified or unknown. Corresponds to TMDB code 0.
  UNKNOWN("Unknown", 0),
  /// Female gender. Corresponds to TMDB code 1.
  FEMALE("Female", 1),
  /// Male gender. Corresponds to TMDB code 2.
  MALE("Male", 2),
  /// Non-binary gender. Corresponds to TMDB code 3.
