...
class IngestConsumer {
  ...
  ///
  /// Any exception thrown while scraping is logged and the message is
  /// negatively acknowledged. This uses the default RabbitMQ configuration in 
  /// Quarkus which is to drop nack'd messages.
  ///
