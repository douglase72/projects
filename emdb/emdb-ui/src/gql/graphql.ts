...
export type MovieQuery = { movie: { id: number, title: string, releaseDate: string | null, score: number, status: ShowStatus, runtime: number, budget: number, revenue: number, backdrop: string | null, poster: string | null, homepage: string | null, originalLanguage: string, tagline: string | null, overview: string | null, credits: { cast: Array<{ id: number, name: string, profile: string | null, character: string | null, order: number }> } } | null };
...
export type PersonQuery = { person: { id: number, name: string, birthDate: string | null, deathDate: string | null, gender: Gender, profile: string | null, birthPlace: string | null, biography: string | null } | null };
