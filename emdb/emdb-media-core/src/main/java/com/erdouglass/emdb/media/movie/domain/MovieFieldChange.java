...
public record MovieFieldChange(MovieField field, String oldValue, String newValue, FieldOperation operation) {

  public MovieFieldChange {
  ...
  public static MovieFieldChange added(MovieField field, Object newValue) {
    return new MovieFieldChange(field, null, str(newValue), FieldOperation.ADDED);
  }
  ...
  public static MovieFieldChange updated(MovieField field, Object oldValue, Object newValue) {
    return new MovieFieldChange(field, str(oldValue), str(newValue), FieldOperation.UPDATED);
  }
  ...
  public static MovieFieldChange deleted(MovieField field, Object oldValue) {
    return new MovieFieldChange(field, str(oldValue), null, FieldOperation.DELETED);
  }
