...
public record ReleaseDate(DateTime value) {
  ...
  public static ReleaseDate of(DateTime releaseDate) { return new ReleaseDate(releaseDate); }
  public static ReleaseDate from(LocalDate releaseDate) { return new ReleaseDate(DateTimeFactory.from(releaseDate)); }
  public static ReleaseDate from(String releaseDate) { return new ReleaseDate(DateTimeFactory.from(releaseDate)); }
  public LocalDate toLocalDate() { return value.toLocalDate(); }
}
