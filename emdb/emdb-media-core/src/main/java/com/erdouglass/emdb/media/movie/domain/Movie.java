...
public final class Movie {
  ...
  /// @throws NullPointerException if `id`, `sourceId` or `details` is `null`
  public static Movie create(MovieId id, SourceId sourceId, MovieDetails details) {
    return new Movie(id, null, sourceId, details, null);
  }
  ...
  /// application code creates movies with [#create(MovieId, SourceId, MovieDetails)].
  ///
  ...
  public static Movie rehydrate(
      ...
      MovieDetails details, 
      Version version) {
    return new Movie(id, publicId, sourceId, details, version);
  }
