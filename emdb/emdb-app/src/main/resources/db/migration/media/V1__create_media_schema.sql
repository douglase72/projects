...
alter table if exists emdb_media.movie drop constraint if exists uq_movie_source_id;
...
alter table if exists emdb_media.person add constraint uq_person_source_id unique (source, source_id);
