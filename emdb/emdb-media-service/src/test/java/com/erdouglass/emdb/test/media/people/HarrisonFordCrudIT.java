package com.erdouglass.emdb.test.media.people;
...
class HarrisonFordCrudIT extends AbstractTest {
  ...
  void testCreatePerson() throws IOException, InterruptedException {
    var createRequest = PersonCreateRequest.builder()
        ...
        .profile("/kuPpElzfYnzsCye0hF8EbJSrvwo.jpg")
  ...
  void testFindById() throws IOException, InterruptedException {
    ...
    assertEquals("/kuPpElzfYnzsCye0hF8EbJSrvwo.jpg", person.profile());
  ...
  void testUpdatePerson() throws IOException, InterruptedException {
    var patchRequest = PersonUpdateRequest.builder()
        .deathDate(LocalDate.parse("2025-12-20"))
    ...
    assertEquals("Harrison Ford", person.name());
    assertEquals("1942-07-13", person.birthDate().toString());
    assertEquals("2025-12-20", person.deathDate().toString());
    assertEquals(3, person.tmdbId());
  ...
  void testVerifyDeletedMovie() throws IOException, InterruptedException {
    ...
    LOGGER.infof("Verified deleted person in: %d ms", et);
  }
