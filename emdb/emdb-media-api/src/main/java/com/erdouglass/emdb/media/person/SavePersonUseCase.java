...
/// Ingestion port: upserts a person keyed by its TMDB id.
///
...
public interface SavePersonUseCase {
  ...
  /// Creates the person if no person carries this TMDB id, otherwise replaces the
  ...
  /// @throws LockedPersonException if a movie with this TMDB id exists and is
