...
class PersonCrudIT extends AbstractTest {
  private static final Logger LOGGER = Logger.getLogger(PersonCrudIT.class);
  private static final UUID PROFILE = UUID.fromString("019d3220-aead-702b-a997-5700e9a2076a");  
  ...
  void testSavePerson() throws IOException, InterruptedException {
    var command = SavePerson.builder()
        ...
        .gender(Gender.MALE)
        .profile(Image.of(PROFILE, "/p7VptoDCwgbdujzEzrFJrHH4pYA.jpg"))
    ...
    var person = OBJECT_MAPPER.readValue(response.body(), PersonDetails.class);
    personId = person.id();
    ...
    assertEquals("019d3220-aead-702b-a997-5700e9a2076a.jpg", person.profile());
